...
class Plotter:
    def __init__ (self, data):
        '''This class is used to generate visualisations of the data and calculate related test statistics.
        
        Attributes:
            
            data (pd.DataFrame): a DataFrame passed as an argument to a class instance.
            ax (matplotlib.axes.Axes, optional): An Axes object for plotting. Intialised as None.''' # Consider re-phrasing above line: is it passed to a class instance or use don initialisation? Or something...
        self.data = data
        self.ax = None

    def msno_plot(self):
        '''This method creates a MissingNo matrix, visualising the distributuion of missing values in each data series.'''
        msno.matrix(self.data)
    
    def heatmap(self, w, h):
        '''This method creates a heatmap of null values in each data series.'''
    ...
    def corr_calc(self):
        '''This method selects columns with numeric data types (int64 and float64 only) and calculates and returns a matrix of correlation coefficients'''
        numeric_cols = self.data.select_dtypes(include=["int64", "float64"])
        correlation_matrix = numeric_cols.corr()
        return correlation_matrix

    def correlation(self, w, h):
        '''This method creates a heatmap matrix visualisation of correlation co-efficients across columns with numeric data types, based on the matrix generated by the corr_calc method.'''
